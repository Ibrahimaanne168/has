-- Backup generated on 2026-07-20T17:06:28.207368
...
INSERT INTO `etudiants` (`id`, `user_id`, `filiere_id`, `classe_id`, `matricule`) VALUES (1, 10, 1, 1, '0001');
INSERT INTO `etudiants` (`id`, `user_id`, `filiere_id`, `classe_id`, `matricule`) VALUES (2, 11, 1, 1, '0002');
INSERT INTO `etudiants` (`id`, `user_id`, `filiere_id`, `classe_id`, `matricule`) VALUES (3, 12, 1, 1, '0003');
INSERT INTO `etudiants` (`id`, `user_id`, `filiere_id`, `classe_id`, `matricule`) VALUES (4, 13, 1, 1, '0004');
...
INSERT INTO `notifications` (`id`, `user_id`, `type`, `contenu`, `lien`, `lu`) VALUES (7, 1, 'info', 'Nouvel étudiant ajouté : Batoura Diakhaby', '/admin/etudiants', 0);
INSERT INTO `notifications` (`id`, `user_id`, `type`, `contenu`, `lien`, `lu`) VALUES (8, 1, 'info', 'Nouvel étudiant ajouté : Amadou Barro', '/admin/etudiants', 0);
INSERT INTO `notifications` (`id`, `user_id`, `type`, `contenu`, `lien`, `lu`) VALUES (9, 1, 'info', 'Nouvel étudiant ajouté : Mariame Sam', '/admin/etudiants', 0);
INSERT INTO `notifications` (`id`, `user_id`, `type`, `contenu`, `lien`, `lu`) VALUES (10, 1, 'info', 'Nouvel étudiant ajouté : Aliou Konté', '/admin/etudiants', 0);
...
INSERT INTO `users` (`id`, `role_id`, `login`, `password_hash`, `nom`, `prenom`, `telephone`, `photo`) VALUES (10, 3, 'batoura', 'scrypt:32768:8:1$kC4EHN0SMtyjXwrA$8dd18248e879f52cb8ecde99b2c5c97f406bec94000e3de339faa6fd3255dc1636639ee80269331cb72f42faaead04589e99d95db68b65fc1a2939112ea634dc', 'Diakhaby', 'Batoura', '774288825', NULL);
INSERT INTO `users` (`id`, `role_id`, `login`, `password_hash`, `nom`, `prenom`, `telephone`, `photo`) VALUES (11, 3, 'amadou', 'scrypt:32768:8:1$7q6yF2eWcpXeulmR$a64b8d319fa18a7c92165a266017f5644730a1488399d391b0c80dc014298d76c84a44ec1e71d3c69a648347f4d85e1397797fc29b840f6e713440fa324b53fc', 'Barro', 'Amadou', '786025355', NULL);
INSERT INTO `users` (`id`, `role_id`, `login`, `password_hash`, `nom`, `prenom`, `telephone`, `photo`) VALUES (12, 3, 'mariame', 'scrypt:32768:8:1$nEUsYYlzy02GhZpN$948423b4ccc1b9035a8e6e8a049a0eb821287e448c579c631d4146a0007782bb96d8b55bd99ba4bda4aa24e6b89b53f659582fb6b99d96f7337af8f117ad99b1', 'Sam', 'Mariame', '781796475', NULL);
INSERT INTO `users` (`id`, `role_id`, `login`, `password_hash`, `nom`, `prenom`, `telephone`, `photo`) VALUES (13, 3, 'aliou', 'scrypt:32768:8:1$EwLZPg7rXfVUF5Wq$3ef7f46d4c1a35b23db322c46cdcb6a83aaf4c1dc1cd94755f5e81f834af92a33fe0f5390438fbb5f946c7ea996027db7fca1c9d73a5699e35f3899a4aef5797', 'Konté', 'Aliou', '772026306', NULL);
